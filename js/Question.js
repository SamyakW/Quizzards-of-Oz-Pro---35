class Question {
  ...
  display(){
    this.title.html("Quizzards of Oz");
    ...
    this.question.html("Question:- What time is it when an elephant sits on a fence?" );
    // question.html("Question:- What starts and ends with the letter ‘E’, but has only one letter? " );

    this.question.position(150, 80);
    this.option1.html("1: Time to work around the clock" );
    this.option1.position(150, 100);
    this.option2.html("2: Time to fix the fence" );
    this.option2.position(150, 120);
    this.option3.html("3: 12:00 PM" );
    this.option3.position(150, 140);
    this.option4.html("4:Just after Morning" );
